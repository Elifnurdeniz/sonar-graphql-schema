...
type DelinquencyExclusion implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""
type DelinquencyExclusionConnection {
  """A list of the entities provided by this connection."""
  entities: [DelinquencyExclusion]!
  """
