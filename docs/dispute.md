```graphql
"""A dispute."""
type Dispute implements NotifiableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""The connection wrapper around the `DisputeConnection` type."""
