```graphql
"""An order group."""
type OrderGroup implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""The relationship between an order group and a user."""
type OrderGroupUser implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type OrderGroupUserConnection {
  """A list of the entities provided by this connection."""
  entities: [OrderGroupUser]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
