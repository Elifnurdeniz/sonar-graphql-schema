```graphql
"""A canned reply."""
type CannedReply implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""A canned reply category."""
type CannedReplyCategory implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
