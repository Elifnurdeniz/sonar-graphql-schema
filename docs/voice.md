...
"""A voice provider rate."""
type VoiceProviderRate implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type VoiceProviderRateConnection {
  """A list of the entities provided by this connection."""
  entities: [VoiceProviderRate]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""An import of voice provider rates."""
type VoiceProviderRateImport implements NoteableInterface & NotifiableInterface & FileableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type VoiceProviderRateImportConnection {
  """A list of the entities provided by this connection."""
  entities: [VoiceProviderRateImport]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""A recipe for importing voice provider rates."""
type VoiceProviderRateImportRecipe implements ImportrecipeableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type VoiceProviderRateImportRecipeConnection {
  """A list of the entities provided by this connection."""
  entities: [VoiceProviderRateImportRecipe]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
type VoiceServiceDetailConnection {
  """A list of the entities provided by this connection."""
  entities: [VoiceServiceDetail]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""The relationship between a `VoiceServiceGenericParameter` and a `Tax`."""
type VoiceServiceGenericParameterTax implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type VoiceServiceGenericParameterTaxDefinition implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
