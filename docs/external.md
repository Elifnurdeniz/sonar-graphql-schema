...
"""
type ExternalMarketingProvider implements LoggableInterface & AccessloggableInterface {
...
"""
type ExternalMarketingProviderConnection {
  """A list of the entities provided by this connection."""
  entities: [ExternalMarketingProvider]!
  """
...
"""The `ExternalMarketingProvider` credentials for integration."""
type ExternalMarketingProviderCredential implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
