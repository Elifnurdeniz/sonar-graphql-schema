```graphql
"""A `Poller`."""
type Poller implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
type PollerSetting implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
