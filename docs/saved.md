...
type SavedMessageCategory implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""
type SavedMessageCategoryConnection {
  """A list of the entities provided by this connection."""
  entities: [SavedMessageCategory]!
  """
