```graphql
"""A RADIUS account."""
type RadiusAccount implements SearchableInterface & IpassignmentableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
...
type RadiusAccountConnection {
  """A list of the entities provided by this connection."""
  entities: [RadiusAccount]!
  """
...
type RadiusGroupConnection {
  """A list of the entities provided by this connection."""
  entities: [RadiusGroup]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""A RADIUS group reply attribute."""
type RadiusGroupReplyAttribute implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""A RADIUS server."""
type RadiusServer implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""The history of a RADIUS session."""
type RadiusSessionHistory implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
