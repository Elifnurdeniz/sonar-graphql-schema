...
"""
type FibermapIntegrationConnection {
  """A list of the entities provided by this connection."""
  entities: [FibermapIntegration]!
  """
...
"""FiberMap plan."""
type FibermapPlan implements NoteableInterface & NotifiableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type FibermapPlanConnection {
  """A list of the entities provided by this connection."""
  entities: [FibermapPlan]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""
type FibermapServiceLocationConnection {
  """A list of the entities provided by this connection."""
  entities: [FibermapServiceLocation]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
