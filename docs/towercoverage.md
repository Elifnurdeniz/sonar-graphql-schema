...
type TowercoverageSubmission implements AddressableInterface & FileableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type TowercoverageSubmissionConnection {
  """A list of the entities provided by this connection."""
  entities: [TowercoverageSubmission]!
  """
