...
type VoidedPayment implements DisbursableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""The connection wrapper around the `VoidedPaymentConnection` type."""
