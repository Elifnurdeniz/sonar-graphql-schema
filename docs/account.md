...
type Account implements SearchableInterface & AddressableInterface & ContactableInterface & EmailableInterface & IpassignmentableInterface & IpassignmenthistoryableInterface & TicketableInterface & JobbableInterface & CustomfielddataableInterface & NoteableInterface & TaskableInterface & FileableInterface & RecentitemableInterface & LoggableInterface & AccessloggableInterface {
  ...
  expiring, recurring, and voice services of an account for this billing cycle, including tax.
  """
...
type AccountAdtranMosaicServiceDetail implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
The connection wrapper around the `AccountAdtranMosaicServiceDetailConnection` type.
"""
...
"""
type AccountBillingParameterConnection {
  """A list of the entities provided by this connection."""
  entities: [AccountBillingParameter]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""A tracked event that has occurred for an `Account`."""
type AccountEvent implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type AccountEventConnection {
  """A list of the entities provided by this connection."""
  entities: [AccountEvent]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""An account group."""
type AccountGroup implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type AccountIpAssignmentsConnection {
  """A list of the entities provided by this connection."""
  entities: [AccountIpAssignments]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
