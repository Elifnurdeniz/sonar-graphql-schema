```graphql
"""A phone number."""
type PhoneNumber implements SearchableInterface & LoggableInterface & AccessloggableInterface {
...
"""A phone number type (e.g. mobile, home, work.)"""
type PhoneNumberType implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type PhoneNumberTypeConnection {
  """A list of the entities provided by this connection."""
  entities: [PhoneNumberType]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
