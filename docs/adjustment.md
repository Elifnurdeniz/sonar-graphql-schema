...
type AdjustmentServiceDetail implements LoggableInterface & AccessloggableInterface {
...
"""
type AdjustmentServiceDetailConnection {
  """A list of the entities provided by this connection."""
  entities: [AdjustmentServiceDetail]!
  """
