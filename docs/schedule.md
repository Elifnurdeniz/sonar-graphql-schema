...
type ScheduleAddress implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""
type ScheduleAvailabilityConnection {
  """A list of the entities provided by this connection."""
  entities: [ScheduleAvailability]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""A day and time associated with a `ScheduleAvailability`."""
type ScheduleAvailabilityDayTime implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type ScheduleBlocker implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
An override to a particular day and time a `ScheduleBlocker` would otherwise cover.
"""
type ScheduleBlockerOverride implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type ScheduleTimeOff implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
