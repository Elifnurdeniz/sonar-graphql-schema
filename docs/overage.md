...
type OverageServiceDetail implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""
type OverageServiceDetailConnection {
  """A list of the entities provided by this connection."""
  entities: [OverageServiceDetail]!
  """
