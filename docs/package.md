...
type Package implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""The relationship between a `Package` and a `Service`."""
type PackageService implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
