...
"""A credential for a `DhcpServer`."""
type DhcpServerCredential implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type DhcpServerCredentialConnection {
  """A list of the entities provided by this connection."""
  entities: [DhcpServerCredential]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
type DhcpServerIdentifier implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
