...
type GpsTrackingProvider implements LoggableInterface & AccessloggableInterface {
...
"""
type GpsTrackingProviderConnection {
  """A list of the entities provided by this connection."""
  entities: [GpsTrackingProvider]!
  """
...
"""`GpsTrackingProvider` credentials."""
type GpsTrackingProviderCredential implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
