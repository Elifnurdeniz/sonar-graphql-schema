...
"""An `SnmpOid`."""
type SnmpOid implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""An `SnmpOidThreshold`."""
type SnmpOidThreshold implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type SnmpOidThresholdConnection {
  """A list of the entities provided by this connection."""
  entities: [SnmpOidThreshold]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""
type SnmpOidThresholdViolationConnection {
  """A list of the entities provided by this connection."""
  entities: [SnmpOidThresholdViolation]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""An `SnmpOverride`."""
type SnmpOverride implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type SnmpOverrideConnection {
  """A list of the entities provided by this connection."""
  entities: [SnmpOverride]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
