...
type StoredFilter implements LoggableInterface & AccessloggableInterface {
...
"""A group of filters in a `StoredView`."""
type StoredGroup implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""A stored view."""
type StoredView implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""A `StoredView` associated with a `User`."""
type StoredViewUser implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type StoredViewUserConnection {
  """A list of the entities provided by this connection."""
  entities: [StoredViewUser]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
