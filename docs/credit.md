...
type Credit implements LoggableInterface & AccessloggableInterface {
...
"""A company that processes `CreditCard` transactions."""
type CreditCardProcessor implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type CreditCardProcessorConnection {
  """A list of the entities provided by this connection."""
  entities: [CreditCardProcessor]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""Credentials for a `CreditCardProcessor`."""
type CreditCardProcessorCredential implements LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
