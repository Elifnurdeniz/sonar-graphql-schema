...
"""
type BankAccountProcessorConnection {
  """A list of the entities provided by this connection."""
  entities: [BankAccountProcessor]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""A credential used when processing bank account payments."""
type BankAccountProcessorCredential implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
