...
type Did implements SearchableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""A direct inward dial (DID) assignment."""
type DidAssignment implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type DidAssignmentHistoryConnection {
  """A list of the entities provided by this connection."""
  entities: [DidAssignmentHistory]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
type DidImportRecipe implements ImportrecipeableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
