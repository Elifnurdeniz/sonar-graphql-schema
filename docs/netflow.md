...
type NetflowAllowedSubnet implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
"""
type NetflowAllowedSubnetConnection {
  """A list of the entities provided by this connection."""
  entities: [NetflowAllowedSubnet]!
  """
...
"""A Netflow endpoint."""
type NetflowEndpoint implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type NetflowEndpointConnection {
  """A list of the entities provided by this connection."""
  entities: [NetflowEndpoint]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
type NetflowOnPremise implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""The connection wrapper around the `NetflowOnPremiseConnection` type."""
type NetflowOnPremiseConnection {
  """A list of the entities provided by this connection."""
  entities: [NetflowOnPremise]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
...
"""A whitelisted subnet for a Netflow endpoint."""
type NetflowWhitelist implements NoteableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
type NetflowWhitelistConnection {
  """A list of the entities provided by this connection."""
  entities: [NetflowWhitelist]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
