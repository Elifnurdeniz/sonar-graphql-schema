...
type InternalLocation implements InventoryitemableInterface & GenericinventoryitemableInterface & GenericinventoryitemactionloggableInterface & NoteableInterface & LoggableInterface & AccessloggableInterface {
...
type InternalLocationConnection {
  """A list of the entities provided by this connection."""
  entities: [InternalLocation]!
  """
