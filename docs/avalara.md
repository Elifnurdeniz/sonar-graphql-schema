...
type AvalaraTaxCategory implements NoteableInterface & LoggableInterface & AccessloggableInterface {
...
type AvalaraTaxCategoryConnection {
  """A list of the entities provided by this connection."""
  entities: [AvalaraTaxCategory]!
  """
...
type AvalaraTaxDefinition implements TaxdefinitionableInterface & LoggableInterface & AccessloggableInterface {
  """The ID of the entity."""
  id: Int64Bit!
  """
  An ID that uniquely identifies this entity across the whole Sonar system.
...
"""
type AvalaraTaxDefinitionConnection {
  """A list of the entities provided by this connection."""
  entities: [AvalaraTaxDefinition]!
  """
  An object providing information about the page of results being displayed, as
  well as the total amount of pages/records available.
  """
